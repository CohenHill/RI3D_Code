...
public class Flywheels {
    ...
    //private double Kp1 = 5.5,Ki1 = 0.0,Kd1 = 0.0,Kf1 = 0.0;
    //private double Kp2 = 7,Ki2 = 0.0,Kd2 = 0.0,Kf2 = 0.0;

    private double Kp1 = 0,Ki1 = 0.0,Kd1 = 0.0,Kf1 = 0.0;
    private double Kp2 = 0,Ki2 = 0.0,Kd2 = 0.0,Kf2 = 0.0;
...
//    private static final double NECTAR_PERCENT = 0.55 * MAX_RPM;   // 55%
    private static final double POLLEN_PERCENT = 1960;   // 80% 75%
    private static final double NECTAR_PERCENT = 1260;   // 55% 48%
...
//        targetVelocity1 = POLLEN_RPM;
//        targetVelocity2 = POLLEN_RPM;
        launch_motor_1.setVelocity(POLLEN_PERCENT);
        launch_motor_2.setVelocity(POLLEN_PERCENT);
    }
    public void setNectarPercent(){
//        targetVelocity1 = NECTAR_RPM;
//        targetVelocity2 = NECTAR_RPM;
        launch_motor_1.setVelocity(NECTAR_PERCENT);
        launch_motor_2.setVelocity(NECTAR_PERCENT);
    }

    public void setPowerZero(){
        launch_motor_1.setVelocity(0);
        launch_motor_2.setVelocity(0);
    }
